...
// +kubebuilder:rbac:groups=idp.zx.io,resources=identities,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=idp.zx.io,resources=identities/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=idp.zx.io,resources=identities/finalizers,verbs=update
